...
using ProjectManagment.UI.MVC.Data;
using System.Data;

namespace ProjectManagment.UI.MVC
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            //Add ProjectManageContext
            builder.Services.AddDbContext<ProjectManagerContext>(options => options.UseSqlServer(connectionString));
