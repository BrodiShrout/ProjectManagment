...
namespace ProjectManagment.UI.MVC.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public EmployeesController(ProjectManagerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Employees != null ? 
                          ...
                          Problem("Entity set 'ProjectManagerContext.Employees'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ProjectManagerContext.Employees'  is null.");
            }
            var employee = await _context.Employees.FindAsync(id);
            if (employee != null)
            {
